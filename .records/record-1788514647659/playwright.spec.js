...
(async () => {
  ...
  await page.locator('div:nth-child(2) > button > span').first().click({ force: true, timeout: 5000 });
  await page.waitForTimeout(1000);
  await page.locator('button:nth-child(1) > div > span').first().click({ force: true, timeout: 5000 });
  await page.waitForTimeout(1000);
